...
export class PortfolioComponent {
  ...
  ngOnInit(): void {
   ...
   projects = [
     ...
     { title: 'GasTail Bot', desc: 'O Gastail é um bot para telegram para fazer anotações rápidas de entradas e gastos de modo interativo a fim de criar o hábito do controle financeiro pessoal anotando as dispesas e investimentos com o bot. ', url: 'https://T.me/GasTail_bot', img: 'assets/gastail.jpg'},
