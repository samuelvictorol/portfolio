...
export class PortfolioComponent {
  ...
  ngOnInit(): void {
   ...
   projects = [
     { title: 'ChatCar I.A.', desc: 'Transforme Conversas em Vendas com o ChatCar. Registre sua loja e seu estoque com facilidade na plataforma. Seu cliente é atendido 24h com IA, recebe informações e gera interesse. O ChatCar te entrega contatos com intenção real de compra e sugestões de abordagem.', url: 'https://chatcar.me', img: 'assets/chatcar.png', },
