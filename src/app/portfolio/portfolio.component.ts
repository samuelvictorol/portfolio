...
export class PortfolioComponent {
  ...
  ngOnInit(): void {
   ...
   projects = [
     ...
     { title: 'Favorite Github Users', desc: 'Webapp fullstack utilizando api do Github para armazenamento e edição de usuários favoritos. Utilizando Vue3 e Express com javascript e banco de dados.', url:'https://github.com/samuelvictorol/PUMA-Desafio', img:'assets/ghlist.png',},
