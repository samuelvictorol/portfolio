...
export class PortfolioComponent {
  ...
  ngOnInit(): void {
   ...
   projects = [
     ...
     { title: 'Ecommerce Django', desc: 'Ecommerce em Django (em construção), projeto fullstack de um Ecommerce de roupas com autenticação e integração com api de pagamento.', url:'https://github.com/samuelvictorol/DJANGOEcommerce', img:'assets/ecommerceImg.png',},
