...
export class PortfolioComponent {
  ...
  ngOnInit(): void {
   ...
   projects = [
     ...
     { title: 'PROJUDI - TJGO', desc: 'oftware de processo eletrônico mantido pelo Conselho Nacional de Justiça e em franca expansão em todos os estados do Brasil. Após a sua popularização, o CNJ passou a chamá-lo também de Sistema CNJ. ', url: 'https://projudi.tjgo.jus.br/', img: 'https://novogerenciador.tjma.jus.br/storage/portalweb/20012015_1349.jpg'},
