...
export class PortfolioComponent {
  ...
  ngOnInit(): void {
   ...
   projects = [
     { span: true,title: 'Conversor MP3 e MP4', desc: 'Conversor de vídeos com suporte para múltiplas plataformas que converte gratuitamente para mp3 ou mp4 a partir do link fornecido utilizando apenas Typescript, HTML, CSS e uma API externa.', url: 'conversor', img: 'assets/conversorImg.png', target: '_self'},
     ...
     { title: 'Portfólio Pessoal', desc: 'Criação do meu Portfólio Pessoal utilizando Angular(ainda em construção), deploy no GitHub Pages e utiliza EmailJS na tela de contatos para enviar formulário pro meu email profissional.', url: 'https://github.com/samuelvictorol/portfolio', img: 'assets/portImg.png', },
  ];
