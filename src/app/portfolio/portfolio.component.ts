...
export class PortfolioComponent {
  ...
  ngOnInit(): void {
   ...
   projects = [
     ...
     { img:'assets/solarsystem.png', title: 'Sistema Solar 3D', desc: 'Um projeto pessoal que consiste em um site que viaja pelo sistema solar em 3D utilizando a biblioteca Three.js', url:'https://github.com/samuelvictorol/Solar-System-3js'  },
