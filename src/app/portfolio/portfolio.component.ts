...
export class PortfolioComponent {
  ...
  ngOnInit(): void {
   ...
   projects = [
     ...
     { btn:'', privacity: 'privado', img:'assets/basaImg.png', title: 'BASA', desc: 'Trabalhei em diversos projetos internos do Banco da Amazônia, onde continuo atuando no frontend do Sistem de Taridas utilizando Angular e Express. O protótipo do design e banco de dados foi feito utilizando Axure. Código não disponível para visualização por se tratar de um projeto privado da empresa.',  },
