...
export class PortfolioComponent {
  ...
  ngOnInit(): void {
   ...
   projects = [
     { title: 'AITO SOFTWARES', desc: 'Migramos seus sistemas para a nuvem com foco em redução de custos, automação de rotinas e IA no WhatsApp para captar leads e vender mais. Tudo isso sem parar a operação atual.', img: 'https://aitosoftwares.com/favicon-bg.png', url: 'https://aitosoftwares.com/' , },
     ...
     { title: 'Eletro Nogueira', desc: 'Criação de IA para SDR no whatsapp, criação da landing page, otimização contínua de SEO e migração de sistema para a nuvem com foco em redução de custos.', url:'https://eletronogueira.com.br', img:'https://eletronogueira.com.br/assets/store2.png',},
     { title: 'PROJUDI - TJGO', desc: 'Software de processo eletrônico mantido pelo Conselho Nacional de Justiça e em franca expansão em todos os estados do Brasil. Após a sua popularização, o CNJ passou a chamá-lo também de Sistema CNJ. ', url: 'https://projudi.tjgo.jus.br/', img: 'https://www.tjpr.jus.br/documents/18319/11254383/0001.jpg/3dc9d0e8-ea31-e722-6f1e-af291265595a?t=1500576620840&imageThumbnail=3'},
     ...
     { title: 'Midnight Tickets', desc: 'Bilheteria Online com as menores taxas do mercado, diversas features para monitoramento de eventos e venda de ingressos personalizados utilizando a api do Mercado Pago.', url:'https://midnightickets.netlify.app/', img:'assets/mid.png',},
